...
This project aims to demonstrate quantum machine learning's potential, specifically Quantum Convolutional Neural Network (QCNN), in HEP events classification from particle image data. The <b>code used in the research is wrapped as an open-source package</b> to ease future research in this field by the community. Check the [How to Use](#how-to-use) section to learn more about it.
...
- **Project Details**
  ...
  - [Accepted Proposal](https://github.com/eraraya-ricardo/qml-hep-gsoc-2021/blob/main/Eraraya_Ricardo_Muten_GSoC_2021_Proposal_QCNN.pdf)
